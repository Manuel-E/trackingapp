...
describe "GET search tracking" do
    it "assigns @teams" do
      package = FactoryGirl.create(:package)

      t_id= package.tracking_id
      get :get_package_by_tracking_id, tracking_id:t_id
      expect(assigns(:package).tracking_id).to eq(t_id)
    end
 ...
 describe "Logged admin" do
    ...
    it "Not allow to Cancel packagewith state 'En Bodega'" do
      packages1 = FactoryGirl.create(:package)
      post :cancel_package,tracking_id:packages1.tracking_id
